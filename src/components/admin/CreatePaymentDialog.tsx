...
import { Calendar, DollarSign, Clock, MapPin, Plus, X, User as UserIcon } from 'lucide-react'
import { formatCurrency, formatDate } from '@/lib/utils'
import type { User, Mission, MissionAssignment } from '@/types/database'
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-lg font-semibold">{selectedTechnician?.name || 'Sélectionnez un technicien'}</p>
                </div>
                <div>
