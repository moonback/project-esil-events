    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        ...
        <div className="space-y-6">
            ...
            <CardContent>
              <div className="flex items-center space-x-2">
                {isConfigured ? (
                  ...
                  <>
                    ...
                    <span className="text-red-600 font-medium">Non configuré</span>
                  </>
                )}
              </div>
              ...
              {isConnected && (
                <div className="flex items-center space-x-2 mt-2">
                  ...
                  <span className="text-sm text-green-600">Connexion établie</span>
                </div>
              )}
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Paramètres WhatsApp Business API</CardTitle>
            </CardHeader>
          ...
          <Card>
            ...
            <CardContent className="space-y-2 text-sm text-gray-600">
              <p>• Les messages WhatsApp sont envoyés automatiquement lors de l'assignation de missions</p>
              <p>• Les techniciens reçoivent une confirmation quand ils acceptent une mission</p>
              <p>• Assurez-vous que les numéros de téléphone sont au format français (06...)</p>
              <p>• Les messages sont envoyés via l'API WhatsApp Business</p>
            </CardContent>
          </Card>
        </div>
      </DialogContent>
